...
Revision ID: 5511e24af80f
Revises: 1fdbd8923e21
Create Date: 2016-02-19 15:58:09.465189

"""

# revision identifiers, used by Alembic.
revision = '5511e24af80f'
down_revision = '1fdbd8923e21'
...
def upgrade():
    ...
    sa.Column('date_runs_from', sa.DateTime(), nullable=True),
    sa.Column('date_runs_to', sa.DateTime(), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('diagram_service_id', sa.Integer(), nullable=False),
    ...
    sa.Column('pass_time', sa.Time(), nullable=True),
